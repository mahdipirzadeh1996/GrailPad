...
import "./GrailPolygon.sol";
// import "./MetoToken.sol";
// import "./DaiToken.sol";

contract TokenFarmPolygon {
    string public name = "Token Farm";
    address public owner;
    GrailPolygon public grailToken;
    ...
    constructor(GrailPolygon _grailToken) public {
    ...
    function stakeTokens(uint256 _amount, uint _weeks) public {
        require(_amount > 0, "Amount cannot be 0");
        //transfer mock dai tokens to this contract for staking

        grailToken.transferFrom(msg.sender, address(this), _amount);
        ...
        timeOfStakingFor[msg.sender] = block.timestamp + (_weeks * 1 weeks);
    ...
    function withdrawTokens(uint256 _amount) public {
        ...
        require(block.timestamp >= (timeOfStakingFor[msg.sender]), "The block timestamp should be at least a day after the time of staking");

        //transfer mock dai tokens to this contract for staking
        //daiToken.transfer(msg.sender, _amount);
        grailToken.transfer(msg.sender, _amount);
